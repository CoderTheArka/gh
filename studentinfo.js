...
const firebaseConfig = {
  ...
  //End code
   ...
   function get56(){
    if (document.getElementById('class15').value != 'SELECT THE CLASS'){
      firebase.database().ref('STUDENT/' + document.getElementById('class15').value + '/').remove();
      firebase.database().ref(document.getElementById('class15').value).remove();
      alert('Class Removed!')
    }else{
